...
/**
 * Represents a bullet fired by an enemy plane
 * @author Blake
 *
 */
public class PlaneBullet implements Bullet {
	...
	/**
	 * Creates a new PlaneBullet
	 * @param x the x position
	 * @param y the y position
	 * @param direction the direction of movement
	 */
	public PlaneBullet(double x, double y, double direction) {
		this.x = x;
		this.y = y;
	...
	/**
	 * Draws the PlaneBullet to a given Graphics object
	...
	/**
	 * Returns the hitbox of the PlaneBullet
	 * @return the hitbox of the PlaneBullet
	 */
	...
	public BulletGroup getBulletGroup() {
		// TODO Auto-generated method stub
		return Bullet.BulletGroup.PLANE;
	}
}
